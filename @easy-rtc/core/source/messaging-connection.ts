...
export interface MessagingConnectionHandlers<TMessage = DefaultMessageType> {
...
export interface MessagingConnectionOptions<TMessage = DefaultMessageType> {
  handlers?: MessagingConnectionHandlers<TMessage>;
...
export class MessagingConnection<TMessage = DefaultMessageType> {
  public handlers: MessagingConnectionHandlers<TMessage>;
  ...
  constructor(options?: MessagingConnectionOptions<TMessage>) {
  ...
  private setDataChannelHandlers(dataChannel: RTCDataChannel) {
    ...
    dataChannel.onmessage = (event) => {
      ...
      this.handlers.onMessageReceived?.(data, this);
    };
