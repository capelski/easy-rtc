...
export type OnConnectionClosedHandler = (instance: MessagingConnection) => void;
export type OnConnectionReadyHandler = (instance: MessagingConnection) => void;
export type OnMessageReceivedHandler = (message: string, instance: MessagingConnection) => void;

export interface MessagingConnectionHandlers {
  onConnectionClosed?: OnConnectionClosedHandler;
  onConnectionReady?: OnConnectionReadyHandler;
...
export class MessagingConnection {
  public handlers: MessagingConnectionHandlers;
